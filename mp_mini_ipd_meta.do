...
**MIN OUTCOMES For CALLS

** meta analysis MINI Outcomes for CALLS**

*DEPRESSION
**run linear regression for SDQ total difficulties, first for unadjusted results, overall and then per site**
logit depress calls_full_week
bysort rc: logit depress calls_full_week

**run same model but with confounders
logit depress calls_full_week housing geometrics homeown age gender
bysort rc: logit depress calls_full_week housing geometrics homeown age gender

**Becuase of perfect prediction - instead use penalized logistic regression - execute for each rc
firthlogit depress calls_full_week housing geometrics homeown age gender if rc == "Imphal, Manipur"
firthlogit depress calls_full_week housing geometrics homeown age gender if rc == "Asansol, West Bengal"
firthlogit depress calls_full_week housing geometrics homeown age gender if rc == "Mysore, Karnataka"
firthlogit depress calls_full_week housing geometrics homeown age gender if rc == "NIMHANS, Karnataka"
firthlogit depress calls_full_week housing geometrics homeown age gender if rc == "PGIMER, Chandigarh"
firthlogit depress calls_full_week housing geometrics homeown age gender if rc == "Rishi Valley, Andhra Pradesh"
firthlogit depress calls_full_week housing geometrics homeown age gender if rc == "St John's Research Institute, Karnataka"

**run IPD meta-analysis for Depression
ipdmetan, study(rc) or re(hk) forestplot( ysize(3) range(.06255 16)  xlabel(.0625 .125 .25 .5 1 2 4 8)  ): firthlogit depress calls_full_week housing geometrics homeown age gender

*ANXIETY
**run linear regression for SDQ total difficulties, first for unadjusted results, overall and then per site**
logit anxiety calls_full_week
bysort rc: logit anxiety calls_full_week

**run same model but with confounders
logit anxiety calls_full_week housing geometrics homeown age gender
bysort rc: logit anxiety calls_full_week housing geometrics homeown age gender

**Becuase of perfect prediction - instead use penalized logistic regression - execute for each rc
firthlogit anxiety calls_full_week housing geometrics homeown age gender if rc == "Imphal, Manipur"
firthlogit anxiety calls_full_week housing geometrics homeown age gender if rc == "Asansol, West Bengal"
firthlogit anxiety calls_full_week housing geometrics homeown age gender if rc == "Mysore, Karnataka"
firthlogit anxiety calls_full_week housing geometrics homeown age gender if rc == "NIMHANS, Karnataka"
firthlogit anxiety calls_full_week housing geometrics homeown age gender if rc == "PGIMER, Chandigarh"
firthlogit anxiety calls_full_week housing geometrics homeown age gender if rc == "Rishi Valley, Andhra Pradesh"
firthlogit anxiety calls_full_week housing geometrics homeown age gender if rc == "St John's Research Institute, Karnataka"

**run IPD meta-analysis for Depression
ipdmetan, study(rc) or re(hk) forestplot( ysize(3) range(.06255 16)  xlabel(.0625 .125 .25 .5 1 2 4 8)  ): firthlogit anxiety calls_full_week housing geometrics homeown age gender
